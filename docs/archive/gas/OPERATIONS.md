> 과거 GAS 운영 기록입니다. 현재 운영에는 docs/의 Cloudflare 매뉴얼을 사용하세요.

> 채널 분리: 뉴스는 DISCORD_WEBHOOK_URL, 개념 테스트·예약 발송은 CONCEPT_WEBHOOK_URL만 사용합니다. 개념 Secret 등록: `npm run cf:secrets -- --concept`.
